  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-6 mt-6 max-w-2xl w-full mx-auto mb-12">
      ...
      <Field>
        ...
        <Input
          type="text"
          value={data.personalRefs[0].name}
          onChange={(e) =>
            setField('personalRefs.0.name', e.target.value)
          }
          className="border-none shadow-[0px_4px_4px_0px_#00000040]"
        />
        {errors['personalRefs.0.name'] && (
      ...
      <Field>
        ...
        <Input
          type="tel"
          value={data.personalRefs[0].phone}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
            const digits = sanitizeDigits(e.target.value)
            setField('personalRefs.0.phone', digits)
          }}
          className="border-none shadow-[0px_4px_4px_0px_#00000040]"
        />
        {errors['personalRefs.0.phone'] && (
          <div className="text-rose-500 font-bold text-sm">
            {errors['personalRefs.0.phone']}
          </div>
        )}
      ...
      <Field>
        ...
        <Input
          type="text"
          value={data.personalRefs[1].name}
          onChange={(e) =>
            setField('personalRefs.1.name', e.target.value)
          }
          className="border-none shadow-[0px_4px_4px_0px_#00000040]"
        />
        {errors['personalRefs.1.name'] && (
          <div className="text-rose-500 font-bold text-sm">
            {errors['personalRefs.1.name']}
          </div>
        )}
      ...
      <Field>
        ...
        <Input
          type="tel"
          value={data.personalRefs[1].phone}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
            const digits = sanitizeDigits(e.target.value)
            setField('personalRefs.1.phone', digits)
          }}
          className="border-none shadow-[0px_4px_4px_0px_#00000040]"
        />
        {errors['personalRefs.1.phone'] && (
          <div className="text-rose-500 font-bold text-sm">
            {errors['personalRefs.1.phone']}
          </div>
        )}
